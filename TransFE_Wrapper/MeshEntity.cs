...
public class MeshEntity : global::System.IDisposable {
  ...
  public long ID {
    ...
    get {
      long ret = TransFEPINVOKE.MeshEntity_ID_get(swigCPtr);
      if (TransFEPINVOKE.SWIGPendingException.Pending) throw TransFEPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }
  ...
  public SWIGTYPE_p_std__shared_ptrT_GeomEntity_t getClassification() {
    SWIGTYPE_p_std__shared_ptrT_GeomEntity_t ret = new SWIGTYPE_p_std__shared_ptrT_GeomEntity_t(TransFEPINVOKE.MeshEntity_getClassification(swigCPtr), true);
    if (TransFEPINVOKE.SWIGPendingException.Pending) throw TransFEPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void setClassification(SWIGTYPE_p_std__shared_ptrT_GeomEntity_t arg0) {
    TransFEPINVOKE.MeshEntity_setClassification(swigCPtr, SWIGTYPE_p_std__shared_ptrT_GeomEntity_t.getCPtr(arg0));
    if (TransFEPINVOKE.SWIGPendingException.Pending) throw TransFEPINVOKE.SWIGPendingException.Retrieve();
  }
