...
public class MeshEdge : MeshEntity {
  ...
  public SWIGTYPE_p_std__vectorT_std__shared_ptrT_MeshFace_t_t__iterator getFirstFace() {
    SWIGTYPE_p_std__vectorT_std__shared_ptrT_MeshFace_t_t__iterator ret = new SWIGTYPE_p_std__vectorT_std__shared_ptrT_MeshFace_t_t__iterator(TransFEPINVOKE.MeshEdge_getFirstFace(swigCPtr), true);
    if (TransFEPINVOKE.SWIGPendingException.Pending) throw TransFEPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_std__vectorT_std__shared_ptrT_MeshFace_t_t__iterator getLastFace() {
    SWIGTYPE_p_std__vectorT_std__shared_ptrT_MeshFace_t_t__iterator ret = new SWIGTYPE_p_std__vectorT_std__shared_ptrT_MeshFace_t_t__iterator(TransFEPINVOKE.MeshEdge_getLastFace(swigCPtr), true);
    if (TransFEPINVOKE.SWIGPendingException.Pending) throw TransFEPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public SWIGTYPE_p_setT_std__shared_ptrT_MeshFace_t_t getFaces() {
    SWIGTYPE_p_setT_std__shared_ptrT_MeshFace_t_t ret = new SWIGTYPE_p_setT_std__shared_ptrT_MeshFace_t_t(TransFEPINVOKE.MeshEdge_getFaces(swigCPtr), true);
    if (TransFEPINVOKE.SWIGPendingException.Pending) throw TransFEPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
