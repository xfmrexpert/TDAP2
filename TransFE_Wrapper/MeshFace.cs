...
public class MeshFace : MeshEntity {
  ...
  public SWIGTYPE_p_std__vectorT_std__shared_ptrT_MeshEdge_t_t__iterator getFirstEdge() {
    SWIGTYPE_p_std__vectorT_std__shared_ptrT_MeshEdge_t_t__iterator ret = new SWIGTYPE_p_std__vectorT_std__shared_ptrT_MeshEdge_t_t__iterator(TransFEPINVOKE.MeshFace_getFirstEdge(swigCPtr), true);
  ...
  public SWIGTYPE_p_std__vectorT_std__shared_ptrT_MeshEdge_t_t__iterator getLastEdge() {
    SWIGTYPE_p_std__vectorT_std__shared_ptrT_MeshEdge_t_t__iterator ret = new SWIGTYPE_p_std__vectorT_std__shared_ptrT_MeshEdge_t_t__iterator(TransFEPINVOKE.MeshFace_getLastEdge(swigCPtr), true);
    if (TransFEPINVOKE.SWIGPendingException.Pending) throw TransFEPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public SWIGTYPE_p_std__vectorT_std__shared_ptrT_MeshVertex_t_t getVertexes() {
    SWIGTYPE_p_std__vectorT_std__shared_ptrT_MeshVertex_t_t ret = new SWIGTYPE_p_std__vectorT_std__shared_ptrT_MeshVertex_t_t(TransFEPINVOKE.MeshFace_getVertexes(swigCPtr), true);
    if (TransFEPINVOKE.SWIGPendingException.Pending) throw TransFEPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
