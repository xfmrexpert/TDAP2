...
Matrix<double> ElasticitySC::evaluatePt(point pt){
   //nnd = # DOF/node
   //nen = # nodes/element   

   Matrix<double> B_t(nnd*nen, 3);
   Matrix<double> B(3, nnd*nen);
   Matrix<double> D(3,3);
   Matrix<double> Bt_D_B(nnd*nen, nnd*nen);
   ...
   Matrix<double> dsdx = Map->jacobianInverse(pt);
